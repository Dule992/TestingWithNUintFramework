...
using TestingWithNUintFramework.RestfulBooker.Api.Data;
...
namespace RestfulBooker.Api.Services
{
    public class BookingsService
    {
        ...
        public string GetBookingIds()
        {
            ...
            // request.AddParameter("roomid", "0 OR 1=1", Parameter.Type.QueryString);

            var response = _client.Get<BookingsService>(request);
